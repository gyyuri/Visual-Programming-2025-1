...
namespace _012_Labels_art
{
    public partial class Form1 : Form
    {
        ...
        {
            lblArtist.Text = "라파엘로 산치오 다 우르비노는 르네상스 시대 이탈리아의 예술가·화가이며, 흔히 라파엘로(Raffaello)라고 불린다. 고대 그리스의 학자가 학당에 모인 것을 상상해서 그린 그림인 《아테네 학당》이 특히 유명하다.";
        ...
        {
            lblArtist.Text = "다빈치는는 이탈리아의 예술가로 이탈리아를 대표하는 석학(polymath)이다. 그는 화가이자 조각가, 발명가, 건축가 등 다양한 분야와 직업을 갖고 활동했다.";
